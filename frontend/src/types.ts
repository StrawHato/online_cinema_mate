...
export interface Profile { id: number; user_id: number; username: string | null; first_name: string | null; last_name: string | null; gender: string | null; date_of_birth: string | null; info: string | null; avatar: string | null }
...
export interface Payment { uuid: string; status: 'pending' | 'successful' | 'canceled' | 'refunded'; amount: number; created_at: string }
